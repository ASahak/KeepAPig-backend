...
export default class CreateUserDto {
  ...
  @IsString()
  @MinLength(VALIDATORS.NAME.min, { message: MESSAGES.VALIDATIONS.FULL_NAME_MIN })
  @MaxLength(VALIDATORS.NAME.max, { message: MESSAGES.VALIDATIONS.FULL_NAME_MAX })
  @Matches(VALIDATORS.NAME.pattern, { message: MESSAGES.VALIDATIONS.FULL_NAME_PATTERN })
  @Matches(VALIDATORS.NAME.onlyLatinPattern, { message: MESSAGES.VALIDATIONS.FULL_NAME_ONLY_LATIN_PATTERN })
  @Field(() => String)
